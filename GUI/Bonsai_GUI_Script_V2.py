...
def load_csv():
    ...
    for drive in get_mapped_drives():
        try:
            df = pd.read_excel(drive[0:2] + '/Quentin/Head_Fixed_Behavior/Params/Mouse_Room_Params.xlsx', sheet_name='Sheet2', converters={'opto_on': str})
        except:
            pass
...
def push_data():
    for drive in get_mapped_drives():
        try:
            server_data_path = drive[0:2] + '/Quentin/Head_Fixed_Behavior/Data'
        except:
            pass
